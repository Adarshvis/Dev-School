...
function CategoryBadge({ category }: { category: string }) {
  ...
  return <a href="#" className="category">{getCategoryLabel(category)}</a>
}

export default function CMSBlogDetailsPage({ slug }: CMSBlogDetailsPageProps) {
  const [data, setData] = React.useState<BlogDetailsData | null>(null)
            ...
            <div className="author-bio-section mt-5" data-aos="fade-up">
              <div className="author-bio-card">
                ...
                <div className="author-details">
                  ...
                  <p className="author-description">{authorBio}</p>
                </div>
              </div>
            </div>
          )}
                  ...
                  <div key={relatedPost.id} className="col-lg-4 col-md-6">
                    <div className="post-card">
                      ...
                      <div className="post-content">
                        ...
                        <p>{relatedPost.shortDescription}</p>
                        <div className="post-meta">
                          <span>
                            <i className="bi bi-calendar"></i> {new Date(relatedPost.publishedDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                          </span>
                          {relatedPost.readTime && (
                            <span>
                              <i className="bi bi-clock"></i> {relatedPost.readTime}
                            </span>
                          )}
                        </div>
                      </div>
